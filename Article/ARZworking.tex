...
\begin{align} 
v(x,t) &= v_{\text{step}}\left[e^{-\frac{x}{\lambda_1\tau}}\left(1 - e^{-\alpha \left(t-\frac{x}{\lambda_1}\right)}\right)H\left(t-\frac{x}{\lambda_1}\right) + e^{-\alpha\left(t-\frac{x}{\lambda_2}\right)}H\left(t-\frac{x}{\lambda_2}\right)\right] \notag \\
&\quad+ \dfrac{q_{\text{step}}}{\rho^* \tau}\left[- e^{-\frac{x}{\lambda_1\tau}}\left(1 - e^{-\alpha\left(t-\frac{x}{\lambda_1}\right)}\right)H\left(t-\frac{x}{\lambda_1}\right) + \left(1 - e^{-\alpha\left(t-\frac{x}{\lambda_2}\right)}\right)H\left(t-\frac{x}{\lambda_2}\right) \right] \\
q(x,t) &= v_{\text{step}}\rho^*\tau \alpha\left[e^{-\frac{x}{\lambda_1\tau}}e^{-\alpha\left(t-\frac{x}{\lambda_1}\right)}H\left(t-\frac{x}{\lambda_1}\right) - e^{-\alpha\left(t-\frac{x}{\lambda_2}\right)}H\left(t-\frac{x}{\lambda_2}\right) \right] \notag \\
&\quad+ q_{\text{step}}\left[ e^{-\frac{x}{\lambda_1\tau}}e^{-\alpha\left(t-\frac{x}{\lambda_1}\right)}H\left(t-\frac{x}{\lambda_1}\right) + \left(1 - e^{-\alpha\left(t-\frac{x}{\lambda_2}\right)}\right)H\left(t-\frac{x}{\lambda_2}\right)\right]
\end{align}
