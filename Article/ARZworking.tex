...
\right)
$
is the combination of a gain, a distributed delay with propagation speed $-\lambda_{2}$, and a distributed gain with characteristic distance $\lambda_{1}\tau$ that cancels out for $x = L$. The resulting bode plot is presented below in Figure \ref{fig:Magn_phase_physx_congested}.
