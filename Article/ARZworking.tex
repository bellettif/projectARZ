...
control strategies. The very definition of a "good" model is a complex one and strongly depends on the practitioners' requirements. A first compulsory condition is realism. The model needs to accurately account for the phenomena that are key in the dynamics of the system under scrutiny. For traffic, a common class of models considers that the flow of car behaves as a fluid and aim at offering a precise representation of such phenomena. Practically, Approximations often make the use of such models more convenient. In such a case, for controlling schemes of the system being modeled to be reliable, it is necessary to check that these approximations are theoretically and empirically correct.\\
