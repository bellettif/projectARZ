...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{\string"Fundamental diagram fitting n = 80\string".png}
...
\centering
\begin{tabular}{c}
\includegraphics[width=15cm]{\string"vq_map_n=80_best_tau\string".png}\tabularnewline
\includegraphics[width=15cm]
{\string"xi_map_n=80_best_tau\string".png}
\end{tabular}
