...
\centering
\begin{tabular}{cc}
\includegraphics[width=8cm]{\string"traces_80_80\string".png} 
\tabularnewline
...
\begin{figure}
\centering
\includegraphics[width=8cm]{\string"80_80_q_q_count\string".png}
...
\begin{figure}
\centering
\includegraphics[width=8cm]{\string"Fundamental_diagram_fitting_n_80\string".png}
