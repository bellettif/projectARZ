...
\begin{figure}[H]
\centering
\includegraphics[width=6cm, trim = 10mm 10mm 10mm 10mm]{\string"Fundamental_diagram_fitting_n_80\string".png}
...
%\end{tabular}
\includegraphics[width=8.2cm, trim = 10mm 20mm 0mm 0mm]{\string"xi_map_n_80_best_tau\string".png}
...
%\end{tabular}
\includegraphics[width=8.2cm, trim = 10mm 20mm 0mm 0mm]{\string"vq_map_n_80_best_tau\string".png}
...
\begin{figure}
\centering
\includegraphics[width=6.5cm, trim = 10mm 10mm 10mm 10mm]{\string"80_80_q_q_count\string".png}
...
\centering
\begin{tabular}{c}
\includegraphics[width=5.2cm, trim = 10mm 2mm 10mm 2mm]{\string"80_80_fundamental_diagram_rho_q_count\string".png}
\tabularnewline
\includegraphics[width=5.2cm, trim = 10mm 2mm 10mm 2mm]{\string"80_80_fundamental_diagram_v_q_count\string".png}
\tabularnewline
\includegraphics[width=5.2cm, trim = 10mm 2mm 10mm 2mm]{\string"80_80_fundamental_diagram_v_rho\string".png}
\end{tabular}
...
\centering
\begin{tabular}{c}
\includegraphics[width=5.2cm, trim = 10mm 2mm 10mm 2mm]
{\string"q_v_error_80\string".png}
\tabularnewline
MAE over $\xi_{1}$ and $\xi_{2}$ and sum of both MAE.
\tabularnewline
\includegraphics[width=5.2cm, trim = 10mm 2mm 10mm 2mm]{\string"xi_1_xi_2_error_80\string".png}
\tabularnewline
MAE over $q$ and $v$
\tabularnewline
\end{tabular}
