...
\centering
\begin{tabular}{ccc}
\includegraphics[width=5cm]{\string"80_80_fundamental_diagram_rho_q_count\string".png}
\tabularnewline
\includegraphics[width=5cm]{\string"80_80_fundamental_diagram_v_q_count\string".png}
\tabularnewline
\includegraphics[width=5cm]{\string"80_80_fundamental_diagram_v_rho\string".png}
\end{tabular}
...
\centering
\begin{tabular}{cc}
\includegraphics[height=8cm]{\string"xi_1_map_n_80_best_tau\string".png}
&
\includegraphics[height=8cm]{\string"xi_2_map_n_80_best_tau\string".png}
\end{tabular}
\protect\caption{Data versus predicted for $\xi_1$ and $\xi_2$}
\end{figure}

\begin{figure}[H]
\centering
\begin{tabular}{cc}
\includegraphics[height=8cm]{\string"v_map_n_80_best_tau\string".png}
&
\includegraphics[height=8cm]{\string"q_map_n_80_best_tau\string".png}
\end{tabular}
\protect\caption{Data versus predicted for $v$ and $q$}
\end{figure}
